...
Traykova et al. 2021 for shift-symmetric scalar-tensor theories on a CPL/$w_0w_aCDM$
...
- the YAML's derived-parameter definitions (e.g. `As <- logA`) are carried over so
